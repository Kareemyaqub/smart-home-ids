...
# Smart Home Intrusion Detection System (IoT_Intrusion)

This project implements a machine learning–based Intrusion Detection System (IDS) for smart home and IoT environments using the IoT_Intrusion dataset from Kaggle. The system analyses network traffic patterns to classify activity as either benign or malicious.
...
## Dataset
The project uses the IoT_Intrusion dataset, published by Stratosphere IPS.  
